...
// Get the profile button, user profile div, and user details elements
const profileButton = document.querySelector('.img img');
...
profileButton.addEventListener('click', () => {
  ...
  // Populate the user details elements
  usernameElement.textContent = userData.name;
  passwordElement.textContent = userData.password;
  userImgElement.src = userData.img;
...
document.body.addEventListener("click", (event) => {
  if (!userProfile.contains(event.target) && event.target !== profileButton) {
